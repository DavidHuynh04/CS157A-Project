...
public class CreateFunction {
        // MySQL code for creating the tables as a string
        ...
        public static void createEmptyTable(Connection conn) throws SQLException {
                try (Statement stmt = conn.createStatement()) {
                        ...
                        // Drop tables if they exist to clear them completely
                        stmt.execute("DROP TABLE IF EXISTS Loans, Transactions, Accounts, Users");
                        // If tables does not exist, they are created
